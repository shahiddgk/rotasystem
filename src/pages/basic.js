...
import {
  getAllDatas,nIns,nUpd,nDel,pIns,pUpd,pDel,lIns,lUpd,lDel,
      ...
      return (
          <div className='wrapper'>
              ...
              <Row>
                <Col>
                  {/* <div className='card'> */}
                    ...
                    <Tabs id="basic_tab" defaultActiveKey="nurse" className='mt-2'>
              ...
              <Modal show={nurse.open}
                ...
                <Modal.Footer>
                  <Button variant="secondary" onClick={() => this.nurseModal(false)}>
                    Close
                  </Button>
                  <Button variant="primary" onClick={() => this.nurseConfirm()}>
                    Save
                  </Button>
                </Modal.Footer>
              </Modal>   
